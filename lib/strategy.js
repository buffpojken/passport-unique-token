...
function Strategy(options, verify) {
    ...
    this._tokenHeader = options.tokenHeader ? options.tokenHeader.toLowerCase() : this._tokenHeader;
...
Strategy.prototype.authenticate = function(req, options) {
    ...
    var token = req.headers[this._tokenHeader] || lookup(req.body, this._tokenField) || lookup(req.query, this._tokenQuery) || lookup(req.params, this._tokenParams);
    if(!token) {
